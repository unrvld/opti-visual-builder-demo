...
import RoundImageElement, { isRoundImageLayout } from "./_round-image"
...
export const ImageElementElement : CmsComponent<ImageElementDataFragment, ImageElementLayoutProps> = ({ data, layoutProps, contentLink, inEditMode, ctx }) =>
{
    ...
    if (isRoundImageLayout(layoutProps)) {
        return <CmsEditable as={ RoundImageElement } data={ data } layoutProps={ layoutProps } cmsId={ contentLink.key } ctx={ ctx } cmsFieldName="imageLink"/>
    }
